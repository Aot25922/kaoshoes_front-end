  ...
  <div class="grid grid-cols-4 filter drop-shadow-lg md:pt-5">
    <div class="md:px-2 md:pb-4" v-for="product in productFilterList" :key="product.id">
      <div class="bg-white md:col-span-1 md:p-5 lg:text-lg font-medium md:h-full md:rounded-md drop-shadow-xl relative">
        <div class="relative">
          <img :src="`http://localhost:8080/product/get/${product.productName}`"  class="md:rounded" @error="$event.target.src='https://cdn4.vectorstock.com/i/1000x1000/87/78/website-error-500-internal-server-error-artwork-vector-23988778.jpg'"/>
...
<<<<<<< HEAD:src/components/MenuList.vue
          &emsp;&emsp;{{ menu.descript }}
=======
          {{ product.descript }}
>>>>>>> e3deb318766ad08b39893265839a944b67196a47:src/components/ProductList.vue
        </p>
